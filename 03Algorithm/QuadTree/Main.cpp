...
public:
	...
	// 레벨에 노드 추가하는 함수
	void AddNewNode(const Bound& bounds)
	{
...
int main()
{
	// 레벨 구성
	Level level;
	level.AddNewNode(Bound(60, 80));
	level.AddNewNode(Bound(50, 50));
	level.AddNewNode(Bound(90, 120));
	level.AddNewNode(Bound(150, 150));
	level.AddNewNode(Bound(10, 10));
